...
import { generateApi, GenerateApiParams, GenerateApiParamsFromUrl } from 'swagger-typescript-api';
...
const apis: ApiParams[] = [
  {
    url: `${process.env.VITE_BASE_API_URL}/v3/api-docs/admin-api`,
    name: 'SwaggerTypeAdmin',
  },
  {
...
const generate = ({ name, url }: Pick<GenerateApiParamsFromUrl, 'name' | 'url'>) => {
